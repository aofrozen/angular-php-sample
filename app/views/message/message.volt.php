                ...
                <div class="contact-items">
                    <ul>
                        <li ng-class="{'selected' : contact.select, 'contact' : true}" ng-repeat="contact in mc.message.contacts | filter:contactSearch | reverse">
                            <a href="#" ng-bind="contact.name" chat-button data-friend-id="<?php echo '{{ contact.uid }}'; ?>"></a>
                    </ul>
                </div>
            </div>
            <div class="chat">
                ...
                <div class="user-items">
                    <ul>
                        <li ng-repeat="friend in mc.message.friends | filter:userSearch:strict | reverse">
                            <a ng-href="#" ng-bind="friend.name+' '+friend.firebase.status" chat-button data-friend-id="<?php echo '{{ friend.uid }}'; ?>"></a>
                        </li>
                    </ul>
                </div>
            </div>
