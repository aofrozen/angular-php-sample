<div class="modal" tabindex="-1" role="dialog" profile-photo-item-ctrl>
    <div class="photo-dialog" id="photo-dialog">
        <div class="photo-viewer" photo-viewer>
            ...
            <img ng-src="<?php echo 'http://{{ mc.photoItem.photo.webFileLocation }}'; ?>" class="photo noselect" id="photo-item">
        ...
        <div perfect-scrollbar class="photo-details" wheel-propagation="true" wheel-speed="10" min-scrollbar-length="20">
            ...
            <div class="details-container">
                <div class="header">
                    <div class="avatar">
                        <a ng-href="/profile/<?php echo '{{ mc.photoItem.uid.username || mc.photoItem.uid.uid }}/'; ?>" target="_self"><img class="img-circle" ng-src="<?php echo '{{ mc.photoItem.uid.avatar }}'; ?>"></a>
                    </div>
                    <div class="name">
                        <a ng-href="/profile/<?php echo '{{ mc.photoItem.uid.username || mc.photoItem.uid.uid }}/'; ?>" target="_self"><span ng-bind="mc.photoItem.uid.name"></span></a>
                    </div>
                </div>
            ...
            <div class="comment-container">
                <div class="post">
                    ...
                    <div class="footer">
                        <div class="post-btn text-right">
                            <a href="#" class="btn btn-default-outline btn-lg" photo-comment-button data-photo-id="<?php echo '{{ mc.photoItem._id.$id }}'; ?>" id="comment-submit">Comment</a>
                        </div>
                        <div class="clear-both"></div>
                    </div>
                </div>
                <div class="item" ng-repeat="commentItem in mc.photoItem.comments">
                    <div class="left">
                        <div class="header">
                            <div class="avatar">
                                <a ng-href="/profile/<?php echo '{{ commentItem.uid.username || commentItem.uid.uid }}/'; ?>" target="_self"><img class="img-circle" ng-src="<?php echo '{{ commentItem.uid.avatar }}'; ?>"></a>
                            </div>
                        </div>
                    </div>
                    <div class="right"
                    <div class="header">
                        <div class="name">
                            <a ng-href="/profile/<?php echo '{{ commentItem.uid.username || commentItem.uid.uid }}/'; ?>" target="_self"><span ng-bind="commentItem.uid.name"></span></a>
                        </div>
                    </div>
                    <div ng-bind-html="commentItem.comment | emoji" class="comment"></div>
                    <div><a href="#" delete-photo-comment-button data-comment-id="<?php echo '{{ commentItem._id.$id }}'; ?>" data-comment-index="<?php echo '{{ $index }}'; ?>">Delete</a></div>
