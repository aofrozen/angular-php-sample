...
<?php } else { ?>
    <div ng-controller="profileController" class="profile">
        ...
        <init init-id="<?php echo $pid; ?>"></init>
        <div class="wall"
            ...
            <div class="avatar">
                <img class="img-circle"
                     ng-src="<?php echo '{{ mc.profile.avatar }}'; ?>">
        ...
        <div class="info">
            <div class="info-container">
                ...
                <div class="contacts text-center">
                    <a href="#" class="btn btn-lg btn-default-outline" add-friend-button="<?php echo $pid; ?>"
                       ng-bind="mc.friends.addFriendButtonName || 'loading'">Add Friend</a>
                    <a ng-href="/messages/<?php echo $pid; ?>" class="btn btn-lg btn-default-outline">Message</a>
                </div>
                <div class="options text-center">
                    ...
                    <a ui-sref=".friends" class="btn btn-lg btn-default-blank"
                       ng-class="{'active' : (profileSelectedTab == 'friends')}"><?php echo '{{ mc.friends.friendCount }}'; ?>
                        Friends</a>
                    ...
                    <div class="footer">
                        <div class="media form-group">
                            <div class="media-preview" ng-show="feedMediaDataShow">
                                ...
                                <div class="thumbnail"><a ng-href="<?php echo '{{ feedMediaUrl }}'; ?>"><img
                        ...
                        <div class="media-item">
                            <div ng-show="feed.media.type == 'video'">
                                <div class="thumbnail" ng-show="feed.media.thumbnailUrl"><a
                                            ng-href="/feeds/item/<?php echo '{{ feed._id.$id }}'; ?>/video"><img
                                                ng-src="<?php echo '{{ feed.media.thumbnailUrl }}'; ?>"></a></div>
                                <a ng-href="/feeds/item/<?php echo '{{ feed._id.$id }}'; ?>/video" class="title"
                                   ng-bind="feed.media.title"></a><br>
                            </div>
                            <div ng-show="feed.media.type != 'video'">
                                <div class="thumbnail" ng-show="feed.media.thumbnailUrl"><a
                                            ng-href="<?php echo '{{ feed.media.url }}'; ?>" target="_blank"><img
                                                ng-src="<?php echo '{{ feed.media.thumbnailUrl }}'; ?>"></a></div>
                        ...
                        <div class="comments">
                            <div class="comment-post">
                                <input class="form-control" type="text" placeholder="Write a comment..."
                                       ...
                                       data-feed-id=<?php echo '{{ feed._id.$id }}'; ?> data-feed-index="<?php echo '{{ $index }}'; ?>">
                            </div>
