        ...
        <div class="follow-friends" perfect-scrollbar wheel-propagation="true" wheel-speed="10"
            ...
            <ul>
                ...
                <li ng-repeat="followFriend in mc.user.follows">
                    <a href="#" select-feed-follow-id="{{ '{{ followFriend.followUid.followUid }}' }}"
                    ...
                    <div class="item">
                        ...
                        <div class="media-item">
                            <div ng-show="feed.media.type == 'video'">
                                <div class="thumbnail">
                                    <a ng-href="/feeds/item/{{ '{{ feed._id.$id }}' }}/video"><img
                                                ng-src="{{ '{{ feed.media.thumbnailUrl }}' }}"></a>
                                </div>
                            ...
                            <div ng-show="feed.media.type == 'link'">
                                <div class="thumbnail">
                                    <a ng-href="{{ '{{ feed.media.url }}' }}" target="_blank"><img
                                                ng-src="{{ '{{ feed.media.thumbnailUrl }}' }}"></a>
                                </div>
                        ...
                        <div class="comments">
                            <div class="comment-post">
                                <input class="form-control" type="text" placeholder="Write a comment..."
                                       quick-feed-comment-input data-feed-id="{{ '{{ feed._id.$id }}' }}"
