                ...
                <div class="aside-body bs-sidebar" style="float:left">
                    ...
                    <div ng-repeat="notification in mc.notifications">
                        <div class="item" ng-show="notification.type == 'friend.request'">
                            <div class="avatar"><a ng-href="/profile/<?php echo '{{ notification.fid }}'; ?>"><img
                                            class="img-circle" ng-src="<?php echo '{{ notification.fid.avatar}}'; ?>"></a></div>
                            <div class="body"><a ng-href="/profile/<?php echo '{{ notification.fid }}'; ?>">
                                    <div class="title" ng-bind="<?php echo 'notification.fid.name'; ?>"></div>
                                </a><div class="options"><button class="btn btn-success"
                                       accept-friend-request-button index="<?php echo '{{ $index }}'; ?>" ng-disabled="<?php echo 'notification.disabled'; ?>">Accept</button>
                                <button class="btn btn-danger"
                                   reject-friend-request-button
                                   index="<?php echo '{{ $index }}'; ?>" ng-disabled="<?php echo 'notification.disabled'; ?>">Reject</button></div></div>
                        </div>
